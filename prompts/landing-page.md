...
════════════════════════════════════════
--ink: #fafafa /_ headline / primary text _/
--muted: #a7a6a6 /_ subcopy _/
--nav: #b6b5b5 /_ header links _/
--strip: #8b8a8a /_ partner logos _/
--pill: #ffffff /_ CTA fill _/
--pill-ink: #050505 /_ CTA text _/
...
:root {
--u: calc(100vh / 1058); /_ 1 design px locked to HEIGHT _/
--uw: calc(100vw / 1487);
--h: clamp(var(--u), calc(var(--u) _ .65 + var(--uw) _ .35), calc(var(--u) \* 1.16));
}
...
- width: calc(1492 _ var(--u)); height: calc(1054 _ var(--u))
